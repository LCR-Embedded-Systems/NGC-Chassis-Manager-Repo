...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = axi_gpio_discretes
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.12
 PARAMETER HW_INSTANCE = axi_gpio_tri
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.12
 PARAMETER HW_INSTANCE = axi_gpio_tvf_uart
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = iic
 PARAMETER DRIVER_VER = 3.12
 PARAMETER HW_INSTANCE = axi_iic_fan_ctrl
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = iic
 PARAMETER DRIVER_VER = 3.12
 PARAMETER HW_INSTANCE = axi_iic_si_osc
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = iic
 PARAMETER DRIVER_VER = 3.12
 PARAMETER HW_INSTANCE = axi_iic_temp_sensor
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = iic
 PARAMETER DRIVER_VER = 3.12
 PARAMETER HW_INSTANCE = axi_iic_temp_sensor2
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = iic
 PARAMETER DRIVER_VER = 3.12
 PARAMETER HW_INSTANCE = axi_iic_temp_sensor3
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = iic
 PARAMETER DRIVER_VER = 3.12
 PARAMETER HW_INSTANCE = axi_iic_temp_sensor4
END
