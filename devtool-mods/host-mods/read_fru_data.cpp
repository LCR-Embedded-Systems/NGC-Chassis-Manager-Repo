                                    ...
                                    const std::string& path)
{
    ...
    log<level::INFO>("INFO: running read all properties for the fru now");
...
FruInventoryData readDataFromInventory(const FRUId& fruNum)
{
    ...
    log<level::INFO>("INFO: readDataFromInventory enter");
...
const FruAreaData& getFruAreaData(const FRUId& fruNum)
{
    ...
    log<level::INFO>("INFO: getFruAreaData enter");
