...
void getChassis(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                ...
                Callback&& callback)
{
    BMCWEB_LOG_INFO << "get chassis running now" << "\n";
    ...
    dbus::utility::getSubTreePaths(
        ...
        std::cout << "sensor path is as follows: " << sensorPath << "\n";

        BMCWEB_LOG_INFO << "sensor path is as follows: " << sensorPath.c_str() << "\n";
    ...
    const std::shared_ptr<std::vector<InventoryItem>>& inventoryItems)
{
    ...
    {
        BMCWEB_LOG_INFO << "current connection attempt: " << connection.c_str() << "\n";
        ...
        BMCWEB_LOG_DEBUG << "getManagedObjectsCb async method call here";
        crow::connections::systemBus->async_method_call(
...
{
    BMCWEB_LOG_INFO << "get chassis DATA running now";
...
inline void
    handleSensorCollectionGet(App& app, const crow::Request& req,
                              ...
                              const std::string& chassisId)
{
    BMCWEB_LOG_INFO << "handle sensor collection get running now" << "\n";
...
{
    BMCWEB_LOG_INFO << "requestRoutesSensorCollection running now" << "\n";
