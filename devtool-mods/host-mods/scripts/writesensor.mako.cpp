...
<%
    ...
    if serviceInterface == "org.freedesktop.DBus.Properties" or serviceInterface == "xyz.openbmc_project.Sensor.Value":
        updateFunc = "set::"
        getFunc = "get::"
...
<%
       ...
       if serviceInterface == "org.freedesktop.DBus.Properties" or serviceInterface == "xyz.openbmc_project.temperatureHwmon":
